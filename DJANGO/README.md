# DJANGO - Skill Set para Agentes

Use esta pasta em projetos Django ou Django REST Framework. Ela deixa o agente com skills reais para economizar tokens, auditar o projeto, lidar com GitHub, checar confiança antes de implementar e seguir boas práticas de Django.
...
- `/framework-best-practices revise esta view ou serializer Django.`
...
| `/framework-best-practices` | Aplica boas práticas deste framework. | Antes de editar código Django. |
...
| Skill | Para que serve | Quando usar |
|---|---|---|
| `/framework-best-practices` | Ajuda com apps, models, migrations, views, serializers e permissões. | Antes de alterar models, APIs ou migrations. |
