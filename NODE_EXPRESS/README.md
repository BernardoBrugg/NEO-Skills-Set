# NODE_EXPRESS - Skill Set para Agentes

Use esta pasta em APIs Node.js com Express. Ela deixa o agente com skills reais para economizar tokens, auditar o projeto, lidar com GitHub, checar confiança antes de implementar e seguir boas práticas de Express.
...
- `/framework-best-practices revise esta rota ou middleware Express.`
...
| `/framework-best-practices` | Aplica boas práticas deste framework. | Antes de editar código Express. |
