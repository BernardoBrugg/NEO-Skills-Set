# NEXT - Skill Set para Agentes

Use esta pasta em projetos Next.js. Ela deixa o agente com skills reais para economizar tokens, auditar o projeto, lidar com GitHub, checar confiança antes de implementar e seguir boas práticas de Next.js.
...
- `/framework-best-practices revise esta rota ou componente Next.js.`
- `/threejs crie uma cena 3D em uma pagina Next.js.`
...
| `/framework-best-practices` | Aplica boas práticas deste framework. | Antes de editar código Next.js. |
...
| Skill | Para que serve | Quando usar |
|---|---|---|
| `/design-taste-frontend` | Evita UI generica e melhora layout, tipografia, spacing e direção visual. | Landing pages, portfolios e redesigns. |
...
| `/redesign-existing-projects` | Audita UI existente e melhora sem quebrar funcionalidade. | Projetos já existentes. |
| `/minimalist-ui` | Direção editorial minimalista. | Produtos calmos, SaaS premium e interfaces limpas. |
| `/high-end-visual-design` | Direção visual premium com acabamento de agência. | Landing pages e experiências de marca. |

### Skills específicas desta pasta

| Skill | Para que serve | Quando usar |
|---|---|---|
| `/threejs` | Ajuda a criar cenas 3D/WebGL com Three.js e React Three Fiber. | Para experiências 3D em apps Next.js. |
