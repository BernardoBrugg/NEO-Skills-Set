# AI_RAG - Skill Set para Agentes

Use esta pasta em projetos de IA, RAG, embeddings, chatbots e agentes LLM. Ela deixa o agente com skills reais para economizar tokens, auditar o projeto, lidar com GitHub, checar confiança antes de implementar e seguir boas práticas de IA/RAG.
...
- `/framework-best-practices revise este pipeline RAG ou chain LLM.`
- `/threejs crie um pipeline RAG com avaliação básica.`
...
| `/framework-best-practices` | Aplica boas práticas deste framework. | Antes de editar código de IA/RAG. |
...
| Skill | Para que serve | Quando usar |
|---|---|---|
| `/langchain` | Ajuda a criar chains, agentes, tools e pipelines RAG com LangChain. | Para apps LLM baseados em LangChain. |
| `/lancedb` | Ajuda com banco vetorial LanceDB. | Para armazenamento e busca vetorial local/server. |
| `/langfuse` | Ajuda com observabilidade de prompts, traces e avaliações LLM. | Para monitorar qualidade, custo e latência. |
