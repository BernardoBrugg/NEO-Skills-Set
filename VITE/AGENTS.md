...
3. Prefira mudancas pequenas, testaveis e alinhadas ao padrao local.
4. Explique riscos antes de comandos destrutivos.
5. Teste quando a mudanca tocar comportamento.
...
- Use `/design-taste-frontend` ou `/gpt-taste` quando a tarefa envolver UI visual, landing pages, redesign ou acabamento frontend.
