# VITE - Skill Set para Agentes

Use esta pasta em projetos React com Vite. Ela deixa o agente com skills reais para economizar tokens, auditar o projeto, lidar com GitHub, checar confiança antes de implementar e seguir boas práticas de Vite/React.
...
- `/framework-best-practices revise este componente Vite/React.`
...
| `/framework-best-practices` | Aplica boas práticas deste framework. | Antes de editar código Vite/React. |
...
| Skill | Para que serve | Quando usar |
|---|---|---|
| `/threejs` | Ajuda a criar cenas 3D/WebGL com Three.js e React Three Fiber. | Para experiências 3D em apps Vite/React. |
